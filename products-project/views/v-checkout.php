    ...
    <div class="container">
        <div class="row">
            <div class="col-6 mb-5">
                <form class="p-4 border border-primary" action="./checkout-page.php" method="POST" style="border: solid 2px; border-radius: 2%;">
                    ...
                    <div class="form-group">
                        ...
                        <?php
                        if (!empty($systemErrors['last_name'])) { ?>
                    ...
                    <div class="card-body">
                        ...
                        <?php foreach ($items as $item) { ?>
                            ...
                            <div class="item-container row">
                                <div class="col-4">
                                    <img class="rounded" width="175px" height="175px" src="<?php echo htmlspecialchars($item->getProduct()->img); ?>" alt="Card image cap">
                                </div>
                                <div class="col-8">
                                    <h3 class="card-title"><?php echo htmlspecialchars($item->getProduct()->title); ?></h3>
                                    <p class="text-primary">Price: <?php echo htmlspecialchars($item->getProduct()->price); ?> $</p>
                                    <p class="text-primary">Quantity: <?php echo htmlspecialchars($item->getQuantity()); ?></p>
                                    <p class="text-primary">Price with quantity: <?php echo htmlspecialchars($subtotal); ?> $</p>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
